...
import exercise.edu.filemanagement.databinding.FileItemRowBinding;
    ...
    public static class FileViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public void bind(FileModel fileModel) {
            ...
            if (fileModel.getType() == FileType.DIRECTORY) {
                binding.iconIv.setBackgroundResource(R.drawable.ic_baseline_folder_24);
            } else {
                binding.iconIv.setBackgroundResource(R.drawable.ic_baseline_insert_drive_file_24);
            }
